...
declare module Q {
    ...
    interface Promise<T> {
         ...
         */
        then<U>(onFulfill: (value: T) => U | IPromise<U>, onReject?: (reason: any) => U | IPromise<U>, onProgress?: Function): Promise<U>;
    ...
    export function when<T, U>(value: T, onFulfilled: (val: T) => U | IPromise<U>): Promise<U>;
    
    export function when<T, U>(value: IPromise<T>, onFulfilled: (val: T) => U | IPromise<U>, onRejected?: (reason: any) => U | IPromise<U>, onProgress?: (progress: any) => any): Promise<U>;
    ...
    export function fcall<T>(method: (...args: any[]) => T | IPromise<T>, ...args: any[]): Promise<T>;
     ...
     * This is especially useful in conjunction with all.
     */
    export function spread<U>(promises: any[], onFulfilled: (...args: any[]) => U | IPromise<U>, onRejected?: (reason: any) => U | IPromise<U>): Promise<U>;
     ...
     * This is especially useful in conjunction with all.
     */
    export function spread<T1, T2, U>(promises: IPromise<T1 | T2>[], onFulfilled: (t1?: T1, t2?: T2) => U | IPromise<U>, onRejected?: (reason: any) => U | IPromise<U>): Promise<U>;
    /**
     * Like then, but "spreads" the array into a variadic fulfillment handler. If any of the promises in the array are rejected, instead calls onRejected with the first rejected promise's rejection reason. 
     * This is especially useful in conjunction with all.
     */
    export function spread<T1, T2, T3, U>(promises: IPromise<T1 | T2 | T3>[], onFulfilled: (t1?: T1, t2?: T2, t3?: T3) => U | IPromise<U>, onRejected?: (reason: any) => U | IPromise<U>): Promise<U>;
    /**
     * Like then, but "spreads" the array into a variadic fulfillment handler. If any of the promises in the array are rejected, instead calls onRejected with the first rejected promise's rejection reason. 
     * This is especially useful in conjunction with all.
     */
    export function spread<T1, T2, T3, T4, U>(promises: IPromise<T1 | T2 | T3 | T4>[], onFulfilled: (t1?: T1, t2?: T2, t3?: T3, t4?: T4) => U | IPromise<U>, onRejected?: (reason: any) => U | IPromise<U>): Promise<U>;
     ...
     */
    export function timeout<T>(promise: Promise<T>, ms: number, message?: string | Error): Promise<T>;

    /**
     * Returns a promise that will have the same result as promise, but will only be fulfilled or rejected after at least ms milliseconds have passed.
     */
    export function delay<T>(promise: Promise<T>| number, ms?: number): Promise<T>;
    /**
     * Returns a promise that will have the same result as promise, but will only be fulfilled or rejected after at least ms milliseconds have passed.
     */
    export function delay<T>(value: T| number, ms?: number): Promise<T>;
